...
var pureJSCalendar = (function () {
    ...
    const dayClick = function (element) {
        ...
        close(element.closest('#cal-frame').parentElement);
    }
    ...
    function close(selector) {
        fadeOutEffect('#cal-' + selector.id, remove(selector.id));
    }
...
function setCalendar(element) {
    pureJSCalendar.open('dd.MM.yyyy', 20, 30, 1, '2018-5-5', '2019-8-20', element.id, 20);
}